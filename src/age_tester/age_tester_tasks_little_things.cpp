...
namespace
{
    age::tester::run_test_t new_tellinglys_test(const std::filesystem::path& screenshot_file)
    {
...
void age::tester::schedule_rom_little_things(const std::filesystem::path& rom_path,

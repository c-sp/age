...
void main()
{
    ...
    vec2 tex_coord1 = (frag_coord + vec2(-2.0, 2.0)) / u_texture_size;
    vec2 tex_coord2 = (frag_coord + vec2(-1.0, 1.0)) / u_texture_size;
    vec2 tex_coord3 = frag_coord / u_texture_size;
    vec2 tex_coord4 = (frag_coord + vec2(1.0, -1.0)) / u_texture_size;
    vec2 tex_coord5 = (frag_coord + vec2(2.0, -2.0)) / u_texture_size;
